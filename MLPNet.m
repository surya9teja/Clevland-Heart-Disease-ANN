...
% Credits: Joshua Gafford (2021). Multi-Layer Perceptron (MLP) Class 
% (https://www.mathworks.com/matlabcentral/fileexchange/74695-multi-layer-perceptron-mlp-class), 
% MATLAB Central File Exchange. Retrieved April 8, 2021.
